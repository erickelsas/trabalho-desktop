 ...
 * @author erick
 */
public class PatientTableView extends javax.swing.JFrame {
    DBController dbController;
    ArrayList<Patient> patientList;
    /**
     * Creates new form PatientTableView
     */
    public PatientTableView(DBController dbController) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientTableView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientTableView().setVisible(true);
            }
        });
    }
    ...
    public void listaTab(){
        ...
        while(posLin < patientList.size()){
            Patient patient = patientList.get(posLin);
            modelo.insertRow(posLin, new Object[]{ patient.getName(), patient.getRg(), patient.getSus(), patient.getBloodType()});
            posLin++;
        }
    }
